...
resource "aws_ecs_service" "ecs_service" {
  ...
  deployment_minimum_healthy_percent = var.deployment_minimum_healthy_percent # Lower limit of tasks that must be running during deployment so that the service remains available
  deployment_maximum_percent         = var.deployment_maximum_percent         # Upper limit of tasks that must be running during deployment. This helps control the rollout speed and resource consumption during updates
