...
3. [AWS Resources Deep Dive](#3-aws-resources-deep-dive)
   ...
   - [3.2. Elastic Container Registry (ECR)](#32-elastic-container-registry-ecr)
   - [3.3. ECS Cluster](#33-ecs-cluster)
   - [3.4. ECS Service](#34-ecs-service)
   - [3.5. Application Load Balancer (ALB)](#35-application-load-balancer-alb)
   - [3.6. SSL Certificate (ACM)](#36-ssl-certificate-acm)
   - [3.7. Route 53](#37-route-53)
   - [3.8. IAM Roles and Policies](#38-iam-roles-and-policies)
   - [3.9. Security Groups](#39-security-groups)
