...
variable "iam_role_arn" {
  description = "IAM role ARN for IRSA (IAM Roles for Service Accounts). Leave empty if not using AWS services."
  type        = string
  default     = ""
}
...
variable "enable_ingress" {
  description = "Enable Ingress resource creation (ALB)"
  type        = bool
  default     = true
}
